...
import { Package, Home, History, MapPin, LogOut, Menu, Bell, User, Settings } from "lucide-react"
            ...
            <div className="flex items-center space-x-4">
                  ...
                  <div className="flex flex-col h-full">
                    <div className="p-6 border-b">
                      <div className="flex items-center space-x-3">
                        ...
                        <div>
                          <h2 className="font-bold text-lg">CourierTrack Pro</h2>
              ...
              <div className="flex items-center space-x-3">
                ...
                <div className="hidden sm:block">
                  <h1 className="text-xl font-bold text-gray-900">CourierTrack Pro</h1>
